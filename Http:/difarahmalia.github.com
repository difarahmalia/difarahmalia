...
function tb5_make ayang(n){
 this.length = n;
 return this.length;
}
 
tb5_messages = new tb5_make ayang (7);
tb5_messages[0] = "Hay bayu";
tb5_messages[1] = "Aku Mau Kamu Tau";
tb5_messages[2] = "Aku Sayang Sama Kamu";
tb5_messages[3] = "Aku Serius sayang";
tb5_messages[4] = "Kamu Mau Nggak selalu ada buat aku";
tb5_messages[5] = "Aku berharap kamu selalu sabar ngadepin aku";
tb5_messages[6] = "I Love You sayangku!!!";
...
tb5_arr = new tb5_make ayang (tb5_messages[tb5_currMsg].length);
tb5_sts = new tb5_make ayang (tb5_messages[tb5_currMsg].length);
...
</br><center><a href="http://difarahmalia.blogspot.com"><img src="https://assets.jalantikus.com/assets/cache/500/346/userfiles/2018/11/15/gambar-anime-romantis-10-3bbdd.jpg"alt="Lolykuu" width="30% atau xpx" height="40% atau ypx"/></a> 
</head>
<body BGCOLOR="black">
<center><center>
<br><font size="6"><font color="red" face="courier new">Touched by:L3M4R1</font>
<br><br><!-- Created By difarah-->
<font size="5"><font color="white" face="courier new">Hai i
<br><font size="5"><font color="white" face="courier new">Selama ini mungkin aku nggak pernah peka sama kamu </font>
<br><font size="5"><font color="white" face="courier new">Namun kali ini Aku ingin mengutarakannya</font>
<br><font size="5"><font color="white" face="courier new"> kalo aku sayang banget sama kamu!kamu sayang sama aku?</font>
<br><a href="https://api.whatsapp.com/send?phone=62895327405888&text=Ya%20aku%20sayang%20kamu"><input type="button" value="Yes I do" onclick="alert('Thanks yah udah mau trima aku apa ada nya');" style="font size="5"></a><><><><a href="https://api.whatsapp.com/send?phone=62895327405888&text=maaf%20aku%20nggabisa%20Terima"><input type="button" value=" Im sorry" onclick="alert('Baik lah kalau itu mau mu ^_^');" style="font size="5"></a>
...
<br><br><br><a href="http://m.instagram.com/iam_difarah.go.id"><input type="button" value="Contact me on Instagram" onclick="alert('Loading, click ok');""></a>
</body>
<style type="text/css">
